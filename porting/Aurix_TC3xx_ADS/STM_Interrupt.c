...
void initLED(void)
{
    IfxPort_setPinMode(LED_1, IfxPort_Mode_outputPushPullGeneral);    /* Initialize LED port pin                      */
    IfxPort_setPinState(LED_1, IfxPort_State_high);                   /* Turn off LED (LED is low-level active)       */

    IfxPort_setPinMode(LED_2, IfxPort_Mode_outputPushPullGeneral);    /* Initialize LED port pin                      */
    IfxPort_setPinState(LED_2, IfxPort_State_high);                   /* Turn off LED (LED is low-level active)       */
}
